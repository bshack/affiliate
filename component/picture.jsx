  ...
  render() {
    ...
    return (
        <picture>
            ...
            <source
                media="(max-width: 39.9375rem)"
                srcSet={cdn + this.props.data.path+ '/' + this.props.data.seoFilenamePart + slug + "-small.jpg"}
            />


            <source
                media="(max-width: 63.9375rem) and (min-resolution: 192dpi), (max-width: 63.9375rem) and (-webkit-min-device-pixel-ratio: 2)"
                srcSet={cdn + this.props.data.path+ '/' + this.props.data.seoFilenamePart + slug + "-medium@2x.webp"}
                type="image/webp"
            />
            <source
