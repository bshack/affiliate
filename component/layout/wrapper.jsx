...
class WrapperLayout extends React.Component {
    render() {
        ...
        if (this.props.data.meta.description && this.props.data.meta.description !== '') {
            ...
            descriptionSEO = <meta name="description" content={this.props.data.config.description} />;
        ...
        return (
            <html lang={this.props.data.config.locale} dir="ltr">
                <head>
                    ...
                    <meta name="twitter:image" content={this.props.data.meta.image} />
                    ...
                    <meta property="og:image:url" content={this.props.data.meta.image} />
